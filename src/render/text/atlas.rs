...
impl GlyphAtlas {
    ...
    pub fn new(device: &wgpu::Device, typ: ContentType) -> Self {
        ...
        let texture = TextureBundle::blank(
            device,
            texture_size,
            texture_size,
            typ.texture_format(),
    ...
    pub fn grow(
        ...
        self.texture = TextureBundle::blank(
            device,
            new_size,
            new_size,
...
pub fn create_atlases_bind_group(
    ...
    mask: &GlyphAtlas,
    color: &GlyphAtlas,
) -> wgsl_draw::globals::BindGroup2 {
    let params = wgsl_draw::globals::BindGroup2EntriesEntriesParams {
    ...
    wgsl_draw::globals::BindGroup2::from_bindings(
        device,
        wgsl_draw::globals::BindGroup2Entries::new(params),
    )
}
